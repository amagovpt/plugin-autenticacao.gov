...
class PKIXExtensions {
    ...
    private static final int SimpleOCSPNoCheck_data [] = { 1, 3, 6, 1, 4, 1, 47668, 1, 3};
     ...
     */
    public static final ObjectIdentifier SimpleOCSPNoCheck_Id;    
    ...
    static {
        ...
        SimpleOCSPNoCheck_Id = ObjectIdentifier.newInternal(SimpleOCSPNoCheck_data);
    }
}
