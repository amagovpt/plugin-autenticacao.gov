...
public class CertId {
    ...
    public CertId(X509Certificate issuerCert, X509Certificate cert) throws IOException {
        this(issuerCert.getSubjectX500Principal(),
             issuerCert.getPublicKey(),new SerialNumber(cert.getSerialNumber()));
    }
    ...
    CertId(X500Principal issuerName, PublicKey issuerKey,
     ...
     * @throws java.io.IOException
     */
    CertId(DerInputStream derIn) throws IOException {
