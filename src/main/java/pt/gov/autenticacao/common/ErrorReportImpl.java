 ...
 */
public class ErrorReportImpl extends AbstractContainer implements ErrorReport {
    private final String estado;
    private final String descricao;   
    
    
    public ErrorReportImpl(PublicKey publicKey, ErrorType tipo, String descricao){
    ...
    public ErrorReportImpl(ErrorType tipo, String descricao){
        this.estado = tipo.name();
        this.descricao = descricao;        
    }
    ...
    public Inputs getInputs() {
        ...
        if (null != pubKey) {
            ...
            } catch (NoSuchAlgorithmException | NoSuchPaddingException | ContainerException ex) {
                inputs = new Inputs();
                inputs.addInput(new Input(ReturnParameter.ESTADO, estado.getBytes()));
            ...
            inputs = new Inputs();
            inputs.addInput(new Input(ReturnParameter.ESTADO, estado.getBytes()));
            inputs.addInput(new Input(ReturnParameter.DESCRICAO, Base64.getEncoder().encodeToString(descricao.getBytes())));
        }
