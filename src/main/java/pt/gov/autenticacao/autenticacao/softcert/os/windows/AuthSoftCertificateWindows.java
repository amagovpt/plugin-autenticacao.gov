package pt.gov.autenticacao.autenticacao.softcert.os.windows;
 ...
 */
public class AuthSoftCertificateWindows extends Operation{    
    private final static Logger LOGGER = Logger.getLogger(AuthSoftCertificateWindows.class.getName());
    private final SoftCertificatesSelector certSelector;
    
    public AuthSoftCertificateWindows(SoftCertificatesSelector certSelector, Map<String, String> params, Requests requests){
    ...
    public Response doOperation() { 
        ...
        try {
            ...
            return new Response();
        } catch (ContainerException | KeyStoreException | IOException | NoSuchAlgorithmException | CertificateException | UnrecoverableKeyException | InvalidKeyException | SignatureException ex) {
